...
const ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999999999999999999999999999999999999999999999999, status: 1, surface: 1, message: `Andromeda`, orderTitle: `Andromeda`, sellerJid: '0@s.whatsapp.net' } } }
...
let capt = ` Title: ${judul}
 ...
 Detail: ${detail}`
            ...
            break
            case 'menu': {
            	let gwe = `_*Andromeda Bot*_
Masih Banyak Bug. Hehe`
            	let imgx = fs.readFileSync(`./lib/thumbnail.jpg`)
            	let btn = [{
urlButton: {
displayText: 'Gc Official Bot',
url: 'https://chat.whatsapp.com/FS5ljl8HKiK1cm3Z7t9haS'
}
}, {
quickReplyButton: {
...
naze.sendButtonText(m.chat, btn, gwe, nyoutube, { quoted: ftroli})
 }
break
            case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'naze': case 'doge':{
            let cz = `* _Status On_*`
           await naze.sendMessage(m.chat, { text: cz, contextInfo:{"externalAdReply": {"title": ` Andromeda Bot`,"body": ` Join Gc Official`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/thumbnail.jpg`),"sourceUrl": "https://chat.whatsapp.com/Chpx5hx3qXq2TWhhfZbp9T"}}}, { quoted: ftroli})
           }
break
