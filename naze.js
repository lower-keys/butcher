...
${ucapanWaktu}\n-Creator : @${ownernya.split('@')[0]}\n-User : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, jawab, `Dim`, { contextInfo:{"externalAdReply": {"title": ` Andromeda Bot`,"body": ` Join Gc Official`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/thumbnail.jpg`),"sourceUrl": "https://chat.whatsapp.com/Chpx5hx3qXq2TWhhfZbp9T"}}}, { quoted: ftroli})
            }
            break
