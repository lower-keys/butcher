...
const { googleImage, youtubeSearch } = require('@bochilteam/scraper')
...
const nyoutube = ('Dim')  //ubah di config biar ngk emror
...
const fliveLoc = {
	 ...
	 message: { "liveLocationMessage": { "caption":"Andromeda","h": `By Dim`, 'jpegThumbnail': fs.readFileSync('./lib/fek.jpg')}}
	}
...
resolve(ab)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await naze.setStatus(`${naze.user.name} On | Runtime : ${runtime(uptime)}`)
...
break
	    ...
	    case 'play': case 'ytplay': {
                if (!text) throw `Example : ${prefix + command} ukraina uraa`
                let yts = require("yt-search")
                let search = await yts(text)
...
 Url : ${anu.url}`,
		...
		let { wikimedia } = require('./lib/scraper')
            ...
            break
            case 'image': {
if (!text) throw `Example : ${prefix + command} anak kecil bernama jari`
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'END:VCARD'
naze.sendMessage(m.chat, { contacts: { displayName: 'Dimzxxxx', contacts: [{ vcard }] } }, { quoted: ftoko })
            }
            break            
            break
            case 'playstore': {
...
${ucapanWaktu}\n-Creator : @${ownernya.split('@')[0]}\n-User : @${me.split('@')[0]}\n-Powered  : @${ini_mark.split('@')[0]}`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, jawab, `Dim`, { contextInfo:{"externalAdReply": {"title": ` Andromeda Bot`,"body": ` Join Gc Official`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/thumbnail.jpg`),"sourceUrl": "https://chat.whatsapp.com/Chpx5hx3qXq2TWhhfZbp9T"}}}, { quoted: ftoko})
            }
            break
...
╰──❍`
                ...
                naze.sendListMsg(m.chat, kukiw, nyoutube, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, fliveLoc)
            }
            break
            case 'mgroup': {
goup = `┌── *Group Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, goup, nyoutube, fliveLoc)
            }
            break
      case 'mwebzone': {
wbzone = `┌── *Webzone Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, wbzone, nyoutube, fliveLoc)
            }
            break
            case 'mdownloader': {
dwnloader = `┌── *Downloader Menu*
│ ${prefix}mediafire [url] / max 100Mb
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dwnloader, nyoutube, fliveLoc)
            }
            break
            case 'msearch': {
sarch = `┌── *Search Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, sarch, nyoutube, fliveLoc)
            }
            break
            case 'mrandom': {
rndom = `┌── *Random Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, rndom, nyoutube, fliveLoc)
            }
            break
            case 'mtextpro': {
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, txtpro, nyoutube, fliveLoc)
            }
            break
            case 'mphotooxy': {
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, potooxy, nyoutube, fliveLoc)
            }
            break
            case 'mephoto': {
ehoto = `┌── *Ephoto Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, ehoto, nyoutube, fliveLoc)
            }
            break
           case 'mfun': {
mun = `┌── *Fun Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, mun, nyoutube, fliveLoc)
            }
            break
            case 'mprimbon': {
pimbon = `┌── *Primbon Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, pimbon, nyoutube, fliveLoc)
            }
            break
            case 'mconvert': {
cnvert = `┌── *Convert Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, cnvert, nyoutube, fliveLoc)
            }
            break
            case 'mmain': {
min = `┌── *Main Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, min, nyoutube, fliveLoc)
            }
            break
            case 'mdatabase': {
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dtbase, nyoutube, fliveLoc)
            }
            break
            case 'manonymous': {
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, aonymous, nyoutube, fliveLoc)
            }
            break
            case 'mislamic': {
islmic = `┌── *Islamic Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, islmic, nyoutube, fliveLoc)
            }
            break
case 'mvoice': {
vice = `┌── *Voice Changer*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, vice, nyoutube, fliveLoc)
            }
            break
            case 'mowner': {
oner = `┌── *Owner Menu*
...
└───────`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, oner, nyoutube, fliveLoc)
            }
            break
            
            case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'naze': case 'doge':{
            let cz = `* _Status On_*`
           await naze.sendMessage(m.chat, { text: cz, contextInfo:{"externalAdReply": {"title": ` Andromeda Bot`,"body": ` Join Gc Official`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/thumbnail.jpg`),"sourceUrl": "https://chat.whatsapp.com/Chpx5hx3qXq2TWhhfZbp9T"}}}, { quoted: fliveLoc})
           }
break
            
            case 'allmenu': {
    let weem = `Dim`
    let thgz = fs.readFileSync('./lib/fek.jpg')
	let texz = `         *Andromeda Bot*
${ucapanWaktu} ${pushname}

*Info*
_*Hari Ini* : ${hariini}_
_*Wib* : ${barat} WIB_
_*Wita* : ${tengah} WITA_
_*Wit* : ${timur} WIT_

_Bot ini masih beta jika banyak bug mohon dimaklumi_
...
-${prefix}setmenu [option]
`
var button = [{ buttonId: `.owner`, buttonText: { displayText: `Owner` }, type: 1 }, { buttonId: `.speed`, buttonText: { displayText: `Speed` }, type: 1 }]
naze.sendMessage(m.chat, { caption: `${texz}`, location: { jpegThumbnail: await reSize(thgz, 200, 200) }, buttons: button, footer:  weem, mentions: [m.sender] })
}


/*await naze.sendMessage(m.chat, { image: thgz, caption: texz, contextInfo:{"externalAdReply": {"title": ` Andromeda Bot`,"body": ` Join Gc Official`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./lib/thumbnail.jpg`),"sourceUrl": "https://chat.whatsapp.com/Chpx5hx3qXq2TWhhfZbp9T"}}}, { quoted: ftoko})*/
